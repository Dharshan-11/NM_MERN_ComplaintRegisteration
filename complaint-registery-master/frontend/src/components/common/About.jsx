    ...
    <div className="about-container">
      ...
      <section className="about-content">
        <div className="about-description"  style={{
          ...
          <h2 style={{fontWeight:"bold",fontSize:"50px",fontFamily:"Orbitron"}}>What is ComplaintHub?</h2>
          <p>
            <strong style={{color:"orangered"}}>ComplaintHub</strong> is a dedicated platform that allows users to easily submit and track their complaints. Whether it's related to public services, customer support, or other concerns, our platform ensures that complaints are registered, assigned to the right department, and resolved in a timely manner.
          </p>
        </div>
